export async function effect_updater(condition, userID) {
    ...
    if (condition.label === "Smite" && game.user.id === userID) {
    ...
    } else if (condition.label === "Protection" && game.user.id === userID) {
        let appliedCondition = actorOrToken.effects.find(function (e) {
    ...
    } else if (condition.label === game.i18n.localize("SUCC.condition.boost") && game.user.id === userID) {
        let appliedCondition = actorOrToken.effects.find(function (e) {
    ...
    } else if (condition.label === game.i18n.localize("SUCC.condition.lower") && game.user.id === userID) {
        let appliedCondition = actorOrToken.effects.find(function (e) {
